...
<div class="damage-section">
	...
	<div class="col-md-6 padding-0">
		<div class="text-container">
			<div class="header-text"><img  class="damage-icon-page" src="<?php echo get_template_directory_uri() ?>/img/flood-icon-page.png"><?php the_title() ?></div>
...
<div class="content-damages-page" id="target-section">
	<?php  query_posts(array('posts_per_page'=>-1,'post_type'=>'is-flood-damage','order'=>'ASC'));?>
