...
<div class="damage-section">
	...
	<div class="col-md-6 padding-0">
		<div class="text-container">
			<div class="header-text"><img  class="damage-icon-page" src="<?php echo get_template_directory_uri() ?>/img/fire-page-icon.png"><?php the_title() ?></div>
			<div class="content-text"><?php the_content() ?></div>
			<a class="content-btn" href="#target-section">Read More</a>
		</div>
	</div>
	<div class="col-md-6 padding-0">
		<div class="full-image-container" style="">
...
<div class="content-damages-page" id="target-section">
	<?php  query_posts(array('posts_per_page'=>-1,'post_type'=>'is-fire-damage','order'=>'ASC'));?>
